"""Experiment stages for Randomized Tests for Subtle Decision Sabotage."""
...
from .decsab._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(out / "report.json", {"headline": "Randomized Tests for Subtle Decision Sabotage", "claims_gated": True})
